...
class RemoteConnection:
    ...
    def __init__(
        ...
        RemoteConnection.extra_headers = (
            self._client_config.extra_headers or RemoteConnection.extra_headers
        )
    ...
    def execute(self, command, params):
        ...
        substitute_params = {
            word[1:] for word in path_string.split("/") if word.startswith("$")
        }  # remove dollar sign
    ...
    def _request(self, method, url, body=None):
        ...
        try:
            ...
            if 399 < statuscode <= 500:
                ...
                return {
                    "status": statuscode,
                    "value": str(statuscode) if not data else data.strip(),
                }
            content_type = []
