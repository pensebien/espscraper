...
class Cookie:
    ...
    def from_dict(cls, data: Dict) -> "Cookie":
        ...
        """
        value = BytesValue(
            data.get("value", {}).get("type"), data.get("value", {}).get("value")
        )
...
class PartitionKey:
    ...
    def __init__(
        self, user_context: Optional[str] = None, source_origin: Optional[str] = None
    ):
...
class Storage:
    ...
    def get_cookies(
        ...
        partition: Optional[
            Union[BrowsingContextPartitionDescriptor, StorageKeyPartitionDescriptor]
        ] = None,
    ) -> GetCookiesResult:
