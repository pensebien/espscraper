...
class CSSFunctionConditionNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            container_queries=(
                CSSContainerQuery.from_json(json["containerQueries"])
                if "containerQueries" in json
                else None
            ),
            supports=(
                CSSSupports.from_json(json["supports"]) if "supports" in json else None
            ),
        )
...
class CSSFunctionNode:
    ...
    def from_json(cls, json):
        return cls(
            condition=(
                CSSFunctionConditionNode.from_json(json["condition"])
