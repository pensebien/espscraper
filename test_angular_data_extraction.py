...
def test_angular_data_extraction():
    ...
    print("🔧 Testing AngularJS Data Extraction for Product Information")
    print("=" * 60)
    ...
    try:
        ...
        try:
            ...
            print("\n📊 Extracting AngularJS product data...")
            ...
            if angular_data:
                ...
                print(f"\n💾 Complete AngularJS data saved to: {output_file}")
...
if __name__ == "__main__":
    ...
    if success:
        print("\n✅ AngularJS data extraction test completed successfully!")
    else:
        print("\n❌ AngularJS data extraction test failed!") 